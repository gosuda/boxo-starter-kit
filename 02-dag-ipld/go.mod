module github.com/gosunuts/boxo-starter-kit/02-dag-ipld

go 1.25.0

require (
	github.com/gosunuts/boxo-starter-kit/00-block-cid v0.0.0-00010101000000-000000000000
	github.com/gosunuts/boxo-starter-kit/01-persistent v0.0.0-00010101000000-000000000000
