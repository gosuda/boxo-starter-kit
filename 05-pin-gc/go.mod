module github.com/gosunuts/boxo-starter-kit/05-pin-gc

go 1.25.0

require (
	github.com/gosunuts/boxo-starter-kit/02-dag-ipld v0.0.0
...
require (
	...
	github.com/gosunuts/boxo-starter-kit/00-block-cid v0.0.0 // indirect
	github.com/gosunuts/boxo-starter-kit/01-persistent v0.0.0 // indirect
